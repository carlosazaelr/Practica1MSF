...
_,Vus1 = ctrl.forced_response(sys,t,u1,x0)
_,Vus2 = ctrl.forced_response(sys,t,u2,x0)
_,Vus3 = ctrl.forced_response(sys,t,u3,x0)
_,Vus4 = ctrl.forced_response(sys,t,u4,x0)
...
plt.plot(t,Vus1,'--',color = clr2,label = 'Vs(t)')
...
plt.plot(t,Vus2,'--',color = clr2,label = 'Vs(t)')
...
plt.plot(t,Vus3,'--',color = clr2,label = 'Vs(t)')
...
plt.plot(t,Vus4,'--',color = clr2,label = 'Vs(t)')
